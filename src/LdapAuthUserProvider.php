    ...
    protected function setInfoArray($infoCollection)
    {
        ...
        */
        if (!empty($this->config['fields'])) {
            ...
            // Adicionado por Públio
            $info['mail'] = $infoCollection->mail;
            $info['lastLogon'] = $infoCollection->lastLogon;
            $info['whenCreated'] = $infoCollection->whenCreated;
            $info['description'] = $infoCollection->description;
            $info['givenName'] = $infoCollection->givenName;
            $info['physicalDeliveryOffice'] = $infoCollection->physicalDeliveryOffice;
            $info['sn'] = $infoCollection->sn;
            $info['department'] = $infoCollection->department;
            $info['departmentNumber'] = $infoCollection->departmentNumber;
            $info['company'] = $infoCollection->company;
            $info['roomNumber'] = $infoCollection->roomNumber;
            $info['title'] = $infoCollection->title;
            $info['employeeID'] = $infoCollection->employeeID;
        }
